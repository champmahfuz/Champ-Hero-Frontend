      ...
      <section className="py-10 bg-gray-100 font-poppins dark:bg-gray-700">
        <div className="px-4 py-4 mx-auto max-w-7xl lg:py-4 md:px-6">
          <div>
            ...
            <div className="rounded-md p-6 mb-8 border bg-gray-50 dark:bg-gray-800 dark:border-gray-800">
            ...
            <div className="flex flex-wrap justify-between">
              <div className="w-full px-4 mb-4 lg:w-1/2 ">
                <div className="rounded-md p-6 border border-blue-100 dark:bg-gray-900 dark:border-gray-900 bg-gray-50 md:p-8">
