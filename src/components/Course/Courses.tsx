...
const Courses = () => {
  ...
  if (!isLoading && !isError && courses?.length === 0)
    content = <p className="text-lg text-destructive">There is no Course</p>;
  if (!isLoading && !isError && courses?.length > 0) {
      ...
      <div className="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
        <div className="mb-14 text-center">
          ...
          <p className="max-w-xl mx-auto text-gray-500">
            Tap into your creativity with our creative writing workshop. Develop
            your writing skills, create compelling stories, and get feedback
            from experienced authors.Take control of your finances. Learn how to
            budget, invest, and plan for a secure financial future with our
