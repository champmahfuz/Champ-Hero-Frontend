      ...
      <div className="p-4 bg-white dark:bg-gray-700">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex">
            <a
              href=""
              className="mr-3 text-lg font-medium text-blue-600 dark:text-gray-300"
            >
              <svg
            ...
            <a
              className="text-lg font-medium text-red-600 dark:text-gray-300"
              href="#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex items-center justify-between ">
          <div className="flex items-center">
            <div>
              <span className="text-sm p-1 px-2 font-bold bg-blue-100 rounded text-gray-700 dark:text-gray-400">
                Seat: {seat}
              </span>
            </div>
          </div>
